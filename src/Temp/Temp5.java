...
public class Temp5 {
    ...
    public static void main(String[] args) throws IOException {
        String inputFile = System.getProperty("user.dir") + "/vlspXMLCorpus/Backup/trainingCorpus.xml";
        String outputFile = System.getProperty("user.dir") + "/vlspXMLCorpus/Backup/newTrainingCorpus.xml";
