...
public class Temp6 {
    public static void main(String[] args) throws IOException {
        String inputFile = System.getProperty("user.dir")+"/vlspXMLCorpus_Refined/newTrainingCorpus.xml";
        String outputFile = System.getProperty("user.dir")+"/vlspXMLCorpus_Refined/vlsp.xml";
