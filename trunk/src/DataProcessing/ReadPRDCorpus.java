 ...
 * @author lelightwin
 */
public class ReadPRDCorpus {

    private BufferedReader bfr;
    private ArrayList<ParseTextNode> pNodes;

    public ReadPRDCorpus(File inputFile) throws FileNotFoundException, UnsupportedEncodingException {
    ...
    public DefaultMutableTreeNode getFullExtractedTreeNode() throws IOException {
        ...
        bfr.close();
//        System.out.println("method:getFullExtractedTreeNode class:ReadPRDCorpus printing...");
//        display(0,root);
        return root;
    }
    ...
    public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException, IOException {
        new ReadPRDCorpus(new File(System.getProperty("user.dir") + "/parsedTreeCorpus_newFormat/25272.prd")).getFullExtractedTreeNode();
    }
}
